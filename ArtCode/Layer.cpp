...
{
	Ethereal::Shader v("Shaders/Default.vert", Ethereal::Type::Vertex);
	Ethereal::Shader f("Shaders/Default.frag", Ethereal::Type::Fragment);
...
void Layer::OnUpdate(Ethereal::Timestep timestep)
{
	...
	Ethereal::Renderer::Submit(VAO, program, glm::translate(glm::identity<glm::mat4>(), transform) * scale);
